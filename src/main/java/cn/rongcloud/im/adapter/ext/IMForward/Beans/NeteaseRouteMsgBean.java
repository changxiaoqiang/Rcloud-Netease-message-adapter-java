...
public class NeteaseRouteMsgBean {
    ...
    public String getMsgTimesta() {
        return msgTimesta;
    }

    public void setMsgTimesta(String msgTimesta) {
        this.msgTimesta = msgTimesta;
    }
    ...
    public String getCustomApnsTex() {
        return customApnsTex;
    }

    public void setCustomApnsTex(String customApnsTex) {
        this.customApnsTex = customApnsTex;
    }
